...
export const MILITARY_BASES: MilitaryBase[] = [
  ...
  { name: "Bushehr Nuclear Power Plant", lat: 28.83, lng: 50.89, operator: "iran", type: "nuclear" },
  ...
  // ──────────────────────────────────────
  // Hezbollah — Lebanon
  { name: "Hezbollah Southern Command, Nabatieh", lat: 33.38, lng: 35.48, operator: "iran_proxy", type: "army" },
  { name: "Hezbollah Bekaa Valley HQ", lat: 33.85, lng: 36.10, operator: "iran_proxy", type: "army" },
  // Houthis — Yemen
  { name: "Houthi Missile Command, Sanaa", lat: 15.36, lng: 44.21, operator: "iran_proxy", type: "missile" },
  { name: "Hudaydah Port (Houthi Naval)", lat: 14.80, lng: 42.95, operator: "iran_proxy", type: "naval" },
  { name: "Houthi Drone Base, Dhamar", lat: 14.55, lng: 44.40, operator: "iran_proxy", type: "air" },
  // Iraqi PMF / IRGC-aligned
  { name: "PMF HQ, Baghdad (Hashd al-Shaabi)", lat: 33.31, lng: 44.37, operator: "iran_proxy", type: "army" },
  { name: "Jurf al-Sakhar Base, Iraq (PMF)", lat: 32.92, lng: 44.12, operator: "iran_proxy", type: "army" },
  // IRGC in Syria
  { name: "T-4 (Tiyas) AB, Syria (IRGC)", lat: 34.52, lng: 37.63, operator: "iran_proxy", type: "air" },
  { name: "Imam Ali Base, Abu Kamal, Syria (IRGC)", lat: 34.45, lng: 40.92, operator: "iran_proxy", type: "army" },
  ...
  { name: "RAF Akrotiri, Cyprus (UK)", lat: 34.59, lng: 32.99, operator: "us_coalition", type: "air" },
  { name: "RAF Dhekelia, Cyprus (UK)", lat: 34.98, lng: 33.72, operator: "us_coalition", type: "army" },
  // Turkey
  { name: "Incirlik AB, Turkey (US/NATO)", lat: 37.00, lng: 35.43, operator: "us_coalition", type: "air" },
  { name: "Kürecik Radar Station, Turkey (NATO)", lat: 38.71, lng: 37.93, operator: "us_coalition", type: "missile" },
  // Jordan
  { name: "Muwaffaq Salti AB, Jordan (US)", lat: 31.83, lng: 36.78, operator: "us_coalition", type: "air" },
  ...
  // Saudi Arabia
  { name: "Prince Sultan AB, Saudi Arabia (US)", lat: 24.06, lng: 47.58, operator: "us_coalition", type: "air" },
  // Oman
  { name: "Thumrait AB, Oman (US access)", lat: 17.67, lng: 54.03, operator: "us_coalition", type: "air" },
  { name: "Masirah Island AB, Oman (US access)", lat: 20.68, lng: 58.89, operator: "us_coalition", type: "air" },
  // Diego Garcia
  ...
  { name: "Ashdod Naval Base", lat: 31.80, lng: 34.63, operator: "israel", type: "naval" },
  { name: "Dimona (Negev Nuclear)", lat: 31.00, lng: 35.15, operator: "israel", type: "nuclear" },
  { name: "Iron Dome Battery, Hadera", lat: 32.44, lng: 34.92, operator: "israel", type: "missile" },
  { name: "Arrow Battery, Palmachim", lat: 31.88, lng: 34.70, operator: "israel", type: "missile" },
  ...
  { name: "King Khalid AB, Khamis Mushait", lat: 18.30, lng: 42.80, operator: "regional", type: "air" },
  ...
  { name: "King Faisal Naval Base, Jeddah", lat: 21.37, lng: 39.17, operator: "regional", type: "naval" },
  { name: "King Abdulaziz Naval Base, Jubail", lat: 27.04, lng: 49.62, operator: "regional", type: "naval" },
  // Jordan
  { name: "King Abdullah II AB, Mafraq", lat: 32.36, lng: 36.26, operator: "regional", type: "air" },
  { name: "King Hussein AB, H-5, Jordan", lat: 32.16, lng: 37.15, operator: "regional", type: "air" },
  // Turkey
  { name: "Konya AB, Turkey", lat: 37.98, lng: 32.56, operator: "regional", type: "air" },
  { name: "Diyarbakir AB, Turkey", lat: 37.89, lng: 40.20, operator: "regional", type: "air" },
  { name: "Ankara-Akinci AB, Turkey", lat: 40.08, lng: 32.57, operator: "regional", type: "air" },
  { name: "Aksaz Naval Base, Turkey", lat: 36.97, lng: 28.40, operator: "regional", type: "naval" },
  // Cyprus
  { name: "Andreas Papandreou AFB, Paphos", lat: 34.72, lng: 32.48, operator: "regional", type: "air" },
  { name: "Larnaca Airport (Military), Cyprus", lat: 34.88, lng: 33.63, operator: "regional", type: "air" },
  // Oman
  ...
  { name: "Said bin Sultan Naval Base, Oman", lat: 23.63, lng: 58.57, operator: "regional", type: "naval" },
  // Iraq
  { name: "Balad AB, Iraq", lat: 33.94, lng: 44.36, operator: "regional", type: "air" },
  { name: "Basra Airport (Military), Iraq", lat: 30.55, lng: 47.66, operator: "regional", type: "air" },
  // Syria
  { name: "Mezzeh Military Airport, Damascus", lat: 33.48, lng: 36.22, operator: "regional", type: "air" },
  ...
  { name: "Beirut Naval Base, Lebanon", lat: 33.90, lng: 35.48, operator: "regional", type: "naval" },
  // Yemen (government)
  ...
  { name: "Berenice Military Base, Egypt", lat: 23.98, lng: 35.47, operator: "regional", type: "air" },
  // Bahrain
  ...
  { name: "Zayed Military City, UAE", lat: 24.10, lng: 54.53, operator: "regional", type: "army" },
];
