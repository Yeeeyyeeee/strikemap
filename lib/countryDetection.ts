...
const COUNTRY_KEYWORDS: Record<string, string[]> = {
  ...
  Jordan: ["jordan", "amman", "aqaba", "zarqa", "irbid", "mafraq", "tower 22"],
  Qatar: ["qatar", "doha", "al udeid"],
  Bahrain: ["bahrain", "manama", "isa air base"],
  Kuwait: ["kuwait", "ali al salem", "bubiyan"],
  Turkey: [
    "turkey",
    "türkiye",
    "ankara",
  ...
  Oman: ["oman", "muscat", "salalah", "duqm", "masirah"],
  Pakistan: [
    "pakistan",
    "islamabad",
    "karachi",
  ...
  Afghanistan: ["afghanistan", "kabul", "kandahar", "herat", "mazar", "jalalabad"],
};
